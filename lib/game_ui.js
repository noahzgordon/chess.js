(function() {
  ...
  UI.prototype.updateCheckStatus = function() {
    ...
    var winner = this.board.isInCheckmate("black") ? "white" : false;
    winner = this.board.isInCheckmate("white") ? "black" : winner;
    ...
    if (winner) {
      ...
      $(".board").fadeOut(400, function() {
        $(".board-wrapper").html(
          "<p>" + UI.capitalize(loser) + "is in checkmate. "
          + UI.capitalize(winner) + " wins!</p>"
